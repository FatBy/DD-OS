...
import { Sparkles, RefreshCw, AlertCircle, Inbox } from 'lucide-react'
      ...
      >
        {doneCount === 0 ? (
          ...
          <div className="text-center">
            ...
            <h2 className="text-lg font-mono text-white/40 mb-2">
              系统就绪
            </h2>
          ...
          /* 有历史任务 - 显示 AI 分析 */
          <div className="rounded-xl border border-white/10 bg-gradient-to-br from-amber-500/5 via-transparent to-cyan-500/5 p-6">
            {/* 标题栏 */}
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                ...
                className="p-1.5 text-white/30 hover:text-amber-400 transition-colors disabled:opacity-50"
                title="刷新分析"
              >
            ...
            {silentAnalysis.timestamp > 0 && (
              <div className="mt-4 pt-3 border-t border-white/5 text-xs font-mono text-white/20">
