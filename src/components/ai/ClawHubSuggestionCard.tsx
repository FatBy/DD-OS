  ...
  return (
    <div className="flex items-center justify-between py-2 px-3 bg-white/5 rounded-lg">
      ...
      <div className="flex items-center gap-2 shrink-0 ml-2">
        <span className="text-xs text-white/30">{formatDownloads(skill.downloads)}</span>
        <button
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-b border-white/5">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-white/30">来自 ClawHub</span>
          </div>
          <button
        ...
        <div className="px-4 py-2 text-xs text-white/50">
          执行 <code className="px-1 py-0.5 bg-white/10 rounded text-white/70">{suggestion.triggerTool}</code> 时未找到对应工具
        </div>
